...
import {FeedFormBaseComponent} from "../form-base.component";

@Component({
    selector: "feed-country-search",
    templateUrl: "./country-search.component.html"
})
export class CountrySearchComponent extends FeedFormBaseComponent implements OnInit {
