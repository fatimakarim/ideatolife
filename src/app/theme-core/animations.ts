...
export const FeedAnimations = [
    ...
    trigger('routerTransitionLeft', [
        ...
        transition('* => *', [
            query('feed-content > :enter, feed-content > :leave', [
                style({
                    position: 'absolute',
                    top     : 0,
                    bottom  : 0,
            ...
            sequence([
                ...
                query('feed-content > :leave', animateChild(), {optional: true}),
                query('feed-content > :enter', animateChild(), {optional: true})
            ])
        ])
    ]),
