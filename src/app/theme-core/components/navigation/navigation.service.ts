...
import {FeedNavigationModelInterface} from "./navigation.model";
...
export class FeedNavigationService {
    ...
    navigationModel: FeedNavigationModelInterface;
    flatNavigation: any[] = [];
    ...
    updateNavigationModel() {
        this.navigationModel = new FeedNavigationModel(this.permissionService);
        this.onNavigationModelChange.next(this.navigationModel.model);
    }
