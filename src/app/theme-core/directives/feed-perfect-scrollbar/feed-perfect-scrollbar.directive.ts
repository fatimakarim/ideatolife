...
import { FeedConfigService } from '../../services/config.service';
import { Subscription } from 'rxjs';
import { Platform } from '@angular/cdk/platform';
import PerfectScrollbar from 'perfect-scrollbar';

@Directive({
    selector: '[feedPerfectScrollbar]'
})
export class FeedPerfectScrollbarDirective implements AfterViewInit, OnDestroy
{
